// Minimal inline icon set (no new dependency) matching the lucide-react
// icons used by the original CV_editor template: MapPin, Phone, Mail,
// Github, Linkedin. Same stroke-based style, sized via the `size` prop.
